...
class VKBot:
    ...
    def name(self, user_id):
        """Метод получает имя пользователя, который отправил сообщение боту"""
    ...
    def get_sex(self, user_id):
        """Метод получает пол человека, меняет на противоположный!"""
        url = f'https://api.vk.com/method/users.get'
        params = {'access_token': user_token,
                  'user_ids': user_id,
                  'fields': 'sex',
    ...
    def get_age_low(self, user_id):
        """Метод получает возраст человека и нижнюю границу для поиска"""
    ...
    def get_age_high(self, user_id):
        """Метод получает возраст человека и верхнюю границу поиска"""
        url = url = f'https://api.vk.com/method/users.get'
        params = {'access_token': user_token,
                  'user_ids': user_id,
                  'fields': 'bdate',
    ...
    def cities(self, user_id, city_name):
        """Метод получает id города человека по названию"""
    ...
    def find_city(self, user_id):
        """Метод получает информацию о городе человека"""
        url = f'https://api.vk.com/method/users.get'
        params = {'access_token': user_token,
                  'fields': 'city',
                  'user_ids': user_id,
    ...
    def find_user(self, user_id):
        """Метод ищет человека по полученным данным"""
    ...
    def get_photos_id(self, user_id):
        """Метод получает id фотографии и ранжирует их в обратном порядке"""
    ...
    def get_photo_1(self, user_id):
        """Метод получает ID фотографии № 1"""
    ...
    def get_photo_3(self, user_id):
        """Метод получает ID фотографии № 3"""
        list = self.get_photos_id(user_id)
        count = 0
        for i in list:
            count += 1
    ...
    def found_person_info(self, offset):
        """Метод выводит информацию о найденном человеке"""
    ...
    def person_id(self, offset):
        """Метод выводит ID найденного человека"""
        tuple_person = select(offset)
        list_person = []
        for i in tuple_person:
            list_person.append(i)
